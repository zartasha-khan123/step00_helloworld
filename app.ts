...
let personName2: string = "ZARTASHIMRAN";
...
let greetings: string = "welcome to the world of coding: ";
...
let absent_guest: string = "father";
let new_guest: string = "sibblings";
...
let new_guest1: string = "sibblings";
...
console.log(
  "/n sorry we can not arrange big table, only two peoples will be invited"
);
...
let absent_guest3: string = "father";
let new_guest3: string = "sibblings";
...
let countries: string[] = ["London", "USA", "Pakistan", "Turkey"];

//write program that creates a list containing these items..
let country: string[] = []; // empty array store values use . push method
country.push("Canada");
...
let newArray: string[] = ["Imran Khan", "Nawaz Shareef", "Bilawal Bhutto"];
...
console.log("Inequality test with strings ", (55 as number) != 57);
...
let city: string[] = ["lahore", "islamabad", "karachi", "peshawar"];
...
let favorite_fruits: string[] = ["mango", "pineapple", "orange"];
...
let user_names: string[] = ["ahmed", "taha", "faizan", "abdul malik", "burhan"];
...
let current_users: string[] = ["faisal", "Ahmed", "taha khan", "saad", "rehan"];

// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users: string[] = ["SARA", "taha khan", "Ahmed", "Wania", "nimRa"];
...
new_users.forEach((newUser) => {
  ...
  if (current_users.map((c_user) => c_user.toLowerCase()).includes(lowerCase)) {
    console.log(
      `The username ${newUser} is not available! please write a different username`
    );
  } else {
...
let favorite_pizza: string[] = ["chicken ", "fatija ", "tandori "];
...
let animals: string[] = ["Dog", "cat", "cube"];
...
let magician: string[] = ["Harry potter","peter boss","john meter","Albus graney"];
...
let magician1: string[] = ["Harry potter","peter boss","john meter","Albus graney"];


function make_great(magiciasArray:string[]){
...
function show_magicians1( magicians:string[]){
 ...
 let magician2: string[] = ["Harry potter","peter boss","john meter","Albus graney"];
 ...
 function make_great1(magiciasArray:string[]){
 ...
 function storeCarInfo(manufacturer:string, model:string, ...extraordinaryopt:{[key:string]: any } [] )
 {
 ...
 // allumdullah complete my 45 assignment
